...
bool getEirValues(uint8_t* eir, char *bdname, uint8_t *bdname_len)
{
	...
	//Erhalte eir(extended inquiry response) data für ein spezifischer Typ (eir enthaltet informationen wie: device name, service class UUIDs für jeden Service, transmission power, manufacturer specific values)

            ...
            RestInterface() {
                api = {
                    ...
                    api_type::tuple_type{
                        ...
                        //--    [ bluetooth ] 2
                        bluetooth_type{&api, &api.get<2>().get<0>(), &api.get<3>(), 2, "bluetooth", false,
                                       bluetooth_type::tuple_type{
                                           ...
                                           bt_list_type{&api.get<2>(), &api.get<2>().get<0>().get<0>(), &api.get<2>().get<1>(), 2, "list", false,
                                                        bt_list_type::tuple_type{
                                                            //--   <count> 0
                                                            LeafNode{&api.get<2>().get<0>(), nullptr, &api.get<2>().get<0>().get<1>(), LN_BT_LIST_COUNT, "count", true, handleWrite,
                                                                     handleRead},
                                                            //--   </count>
                                                            //--   <index> 1
                                                            bt_list_arr_type{&api.get<2>().get<0>(), &api.get<2>().get<0>().get<1>().get<0>(), nullptr, 2, "index", true,
                                                                             bt_list_arr_type::tuple_type{
                                                                                 // name 0
                                                                                 ArrayLeafNode{&api.get<2>().get<0>().get<1>(), nullptr, &api.get<2>().get<0>().get<1>().get<1>(),
                                                                                               AN_BT_LIST_NAME, "name", true, handleWriteArray, handleReadArray},
                                                                                 // uid 1
                                                                                 ArrayLeafNode{&api.get<1>().get<1>(), nullptr, nullptr, AN_BT_LIST_UID, "uid", true,
                                  ...
                                  wifi_type::tuple_type{
                                      ...
                                      wifi_cons_type{
                                          ...
                                          wifi_cons_type::tuple_type{
                                              //--   <count> 0
                                              LeafNode{&api.get<3>().get<2>(), nullptr, &api.get<3>().get<2>().get<1>(), LN_WIFI_CONS_COUNT, "count", true, handleWrite,
                                                       handleRead},
                                              //--   </count>
                                              //--   <index> 1
                                     ...
                                     battery_type::tuple_type{
                                         ...
                                         bat_arr_type{&api.get<4>(), &api.get<4>().get<1>().get<0>(), nullptr, 3, "index", true,
                                                      bat_arr_type::tuple_type{// voltage 0
                                                                               ArrayLeafNode{&api.get<4>().get<1>(), nullptr, &api.get<4>().get<1>().get<1>(), AN_BAT_VOLT,
                                                                                             "voltage", true, handleWriteArray, handleReadArray},
                                                                               // current 1
                                                                               ArrayLeafNode{&api.get<4>().get<1>(), nullptr, &api.get<4>().get<1>().get<2>(), AN_BAT_CURR,
                                                                                             "current", true, handleWriteArray, handleReadArray},
                                                                               // consumption 2
                                                                               ArrayLeafNode{&api.get<4>().get<1>(), nullptr, nullptr, AN_BAT_CONS, "consumption", true,
                                                                                             handleWriteArray, handleReadArray}}}
                                         //--   { /index }
                                     }},
                        //--    [ /wifi ]
                                      ...
                                      settings_type::tuple_type{
                                          ...
                                          settings_step_type{&api.get<6>(), &api.get<6>().get<0>().get<0>(), &api.get<6>().get<1>(), 3, "stepper", false,
                                                             settings_step_type::tuple_type{// changePreStep (0)
                                                                                            LeafNode{&api.get<6>().get<0>(), nullptr, &api.get<6>().get<0>().get<1>(),
                                                                                                     LN_SET_STEP_CPS, "changePerStep", false, handleWrite, handleRead},
                                                                                            // velocity (1)
                                                                                            LeafNode{&api.get<6>().get<0>(), nullptr, &api.get<6>().get<0>().get<2>(),
                                                                                                     LN_SET_STEP_VEL, "velocity", true, handleWrite, handleRead},
                                                                                            // acceleration (2)
                                                                                            LeafNode{&api.get<6>().get<0>(), nullptr, nullptr, LN_SET_STEP_ACC, "acceleration",
                                                                                                     true, handleWrite, handleRead}}},
                                          //-- { /stepper }
                                          //-- { servo } 1
                                          settings_serv_type{&api.get<6>(), &api.get<6>().get<1>().get<0>(), nullptr, 2, "servo", false,
                                                             settings_serv_type::tuple_type{// velocity (0)
                                                                                            LeafNode{&api.get<6>().get<1>(), nullptr, &api.get<6>().get<1>().get<1>(),
                                                                                                     LN_SET_SERV_VEL, "velocity", true, handleWrite, handleRead},
                                                                                            // acceleration (1)
                                                                                            LeafNode{&api.get<6>().get<1>(), nullptr, nullptr, LN_SET_SERV_ACC, "acceleration",
                                                                                                     true, handleWrite, handleRead}}}
                                          //-- { /servo }
                                      }}
                        //--   [ /settings ]
            ...
            cJSON* createJSON(Node* node, cJSON* parent, bool isArrayNode = false, size_t arrayIndex = 0) {
                ...
                if (node->children) {
                    ...
                    for (; child; child = child->next) {
                        ...
                        ESP_LOGI(LOG_TAG, "Going to next node %iX", (uintptr_t)child->next);
                        if (child->next)

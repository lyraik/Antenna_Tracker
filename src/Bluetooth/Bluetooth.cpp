...
etl::vector<utils::String, 10> devices;
...
void esp_bt_gap_cb(esp_bt_gap_cb_event_t event, esp_bt_gap_cb_param_t* param) {
    switch (event) {
        ...
        case ESP_BT_GAP_DISC_RES_EVT: {
            ...
            for (utils::StringView e : devices) {
                if (e == utils::StringView{peer_bdname, peer_bdname_len}) {
                    break;
                }
            }
            utils::String bdname = utils::String::create(peer_bdname_len);
            memcpy(bdname.str, peer_bdname, peer_bdname_len);
            devices.emplace_back(bdname);
            break;
        }
